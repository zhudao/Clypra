...
export const MediaPanel: React.FC<MediaPanelProps> = ({ onAddToTimeline }) => {
  ...
  return (
    <div ref={containerRef} className={`w-64 min-h-0 bg-surface border-r border-border flex flex-col overflow-hidden shrink-0 transition-colors ${isDraggingOver ? "bg-surface-raised/10 transition-colors duration-300" : ""}`}>
