...
const ZH_CN: Record<string, string> = {
  ...
  "Screen Capture Enabled": "已激活屏幕截取", "Microphone Source": "麦克风来源", "No microphone devices found.": "找不到麦克风设备。", "Recording Audio Only": "仅录制音频", "Transcription Language": "转录语言",
  ...
  "Sticker Animation": "贴图动画", "Preset Effects": "缺省效果", "Style Presets": "样式缺省集", "Template Gallery": "范本库", "Typography": "字体排印",
  ...
  "Save changes before closing?": "要在关闭前保存变更吗？", "Don't Save": "不保存", "If you close without saving, your recent edits will be permanently lost.": "如果不保存就关闭，你最近的编辑内容将会永久遗失。",
  ...
  "Procedural Style Preview": "进程式样式预览", "Program Preview": "节目预览", "Project": "项目", "Project Closed": "项目已关闭", "Project File Export Fallback": "项目档导出备援", "Properties": "属性",
